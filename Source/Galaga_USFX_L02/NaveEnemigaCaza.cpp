...
void ANaveEnemigaCaza::Mover(float DeltaTime)
{
    ...
    // Define la velocidad y dirección de movimiento
    FVector VelocidadMovimiento(100.0f, 0.0f, 0.0f); // Velocidad en X

    // Calcula la nueva posición sumando la velocidad al tiempo transcurrido
    FVector NuevaPosicion = PosicionActual + VelocidadMovimiento * DeltaTime;
